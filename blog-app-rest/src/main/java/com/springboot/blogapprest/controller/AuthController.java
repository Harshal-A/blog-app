...
import com.springboot.blogapprest.payload.LoginDto;
import com.springboot.blogapprest.payload.SignUpDto;
import com.springboot.blogapprest.repository.RoleRepository;
...
public class AuthController {
	...
	public ResponseEntity<?> registerUser(@RequestBody SignUpDto signUpDto){
		...
		//add check if email exists in DB
